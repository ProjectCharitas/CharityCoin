...
set "command=& .\multipoolminer.ps1 -DisableDevFeeMining -WarmupTime 60 -Wallet %wallet% -WorkerName v1.0CL -Region us -Currency ltc -DeviceName cpu -PoolName nlpool -Donate 10 -Watchdog -MinerStatusURL https://multipoolminer.io/monitor/miner.php -SwitchingPrevention 3"
